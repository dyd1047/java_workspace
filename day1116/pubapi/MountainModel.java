...
public class MountainModel extends AbstractTableModel{
	...
	public Object getValueAt(int row, int col) {
		//해결책! 조건문을 사용
		//즉 col이 0일 때는 산의 아이디, 1 일때 이름, 2일때 뭐.. 등등이로 우리가 조건을 달아야 한다.
		System.out.println("row = " + row + "col 값 = "+col); //호출 시 컬럼값 확인하기
		...
		//이 메서드의 반환형이 오브젝트 형이므로, 우리는 객체형(String, Integer등)으로 반환해야 함
		//JTable.에 들어가는 모든 데이터는 String 취급할 수 있으므로 String으로 반환
